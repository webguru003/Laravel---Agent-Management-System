	    ...
	    <div class="container">
	      ...
	      <div class="row">
	      	...
	      	<div class="span12">      		
				...
				<form id="add-client" class="form-horizontal" method="POST" action="{{ route('clients.store') }}">
				{{ csrf_field() }}
				<fieldset>
				...
				<div class="controls">
				<input type="text" class="span6" id="contactname" name="contactname" value="{{old('contactname')}}">
				...
				<div class="controls">
				<input type="text" class="span6" id="companyname" name="companyname" value="{{old('companyname')}}">
