...
<div class="main">
	...
	<form id="edit-agent" class="form-horizontal" method="POST" action="{{url("/agents/$agent->id")}}">
				{{ csrf_field() }}
				{{ method_field('PUT') }}
				<fieldset>
				...
				<div class="controls">
				<input type="text" class="span6" id="username" name="username" value="{{$agent->username}}" disabled="disabled">
				...
				<div class="controls">
				<input type="text" class="span6" id="firstname" name="fname" value="{{$agent->fname}}">
				@if ($errors->has('fname'))
				<span class="help-block">
				...
				<div class="controls">
				<input type="text" class="span6" id="lastname" name="lname" value="{{$agent->lname}}">
				@if ($errors->has('lname'))
				<span class="help-block">
				...
				<div class="controls">
				<input type="text" class="span4" id="email" name="email" value="{{$agent->email}}">
				@if ($errors->has('email'))
				<span class="help-block">
				...
				<div class="controls">
				<input type="text" class="span4" id="phone" name="phone" value="{{$agent->phone}}">
				@if ($errors->has('phone'))
				<span class="help-block">
